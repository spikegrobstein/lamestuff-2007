...
if ($error_type == 'controller') {
	...
	$error_title = 'Controller not found!';
	
	$error_msg = 'The controller named '.$path.' could not be loaded because it is either missing or has been moved. If you feel you\'ve reached this message in error, please contact us.';
